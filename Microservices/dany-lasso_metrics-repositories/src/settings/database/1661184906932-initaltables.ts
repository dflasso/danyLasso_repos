...
export class initaltables1661184906932 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_1abba6aba1b308ea3bbd7409da" ON "metric" ("repoIdRepository") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "metric" ADD CONSTRAINT "FK_1abba6aba1b308ea3bbd7409da9" FOREIGN KEY ("repoIdRepository") REFERENCES "repo"("id_repository") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "metric" DROP CONSTRAINT "FK_1abba6aba1b308ea3bbd7409da9"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "metric"@"IDX_1abba6aba1b308ea3bbd7409da" CASCADE`,
    );
